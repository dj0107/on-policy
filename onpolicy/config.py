...
def get_config():
    ...
    parser.add_argument("--use_wandb", action='store_true', default=False, help="[for wandb usage], by default False, uses tensorboard. Pass --use_wandb to enable wandb logging.")
